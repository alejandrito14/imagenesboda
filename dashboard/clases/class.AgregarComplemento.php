		...
		//este if nos sirve para verificar que ya existe la sesion de apunta de venta.
	 	if(!isset($_SESSION['CarritoComplemento']))
	 	{
	 		...
	 		{  
				 ...
				 <div class="col-md-8">
					<h5 class="mb-0" style="font-size: 2em!important;text-align: center;margin-bottom: 1em!important;" data-toggle="collapse" data-target="#collapse'.$k.'" aria-expanded="true" aria-controls="collapseOne">'.$idgrupos.'-'.$nombre.'</h5>
					</h5>
				 </div>
