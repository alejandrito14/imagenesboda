...
class Configuracion
{
	...
	public $texto1;
	public $bloquearediciondatoscliente;
	public $mostraranunciosapp;
	public $activaromitir;
	...
	public function ModificarConfiguracion()
	{
		...
		texto1='$this->texto1',
		ediciondedatoscliente='$this->bloquearediciondatoscliente',
		mostraranuncios='$this->mostraranunciosapp',
		activaromitirfinal='$this->activaromitir'
