...
class NotificacionPush2
{
    ...
    public function getAccessToken() {
        ...
        $credentialsPath = '/home/issoftware/public_html/IS-U-ORDER/catalogos/notificaciones/llavenotificacion/is-u-order-admin-b1d85cb20455.json';  // Asegúrate de que esta ruta sea correcta
...
function EnviarNotificacion($tokenList, $title, $message) {
    ...
    $url = "https://fcm.googleapis.com/v1/projects/is-u-order-admin/messages:send";
