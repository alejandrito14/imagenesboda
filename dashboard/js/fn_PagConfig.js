function g_Configuracion()
{
  ...
  var archivo = archivos.files; //Obtenemos el valor del input (los arcchivos) en modo de arreglo
   ...
   var v_id = $('#v_id').val();
	...
	var bloquearediciondatoscliente=0;
	if ($("#bloquearediciondedatos").is(':checked')) {
		bloquearediciondatoscliente=1;
	}

	var mostraranunciosapp=0;
	if ($("#v_activaranuncios").is(':checked')) {
		mostraranunciosapp=1;
	}
  ...
  for(i=0; i<archivo.length; i++){
	...
	data.append('bloquearediciondatoscliente',bloquearediciondatoscliente);
	data.append('mostraranunciosapp',mostraranunciosapp);
	data.append('activaromitir',activaromitir);
