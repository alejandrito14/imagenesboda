...
//*================== TERMINA RECIBIMOS PARAMETRO DE PERMISOS =======================*/
 ...
 <table class="table" id="tabladireccion" class="table-striped table-bordered ">
...
if($result_clientes_num_direccion  != 0)
{
		...
		do
	{
			...
			$noext=$result_clientes_row_direccion['no_ext'];
			$noint=$result_clientes_row_direccion['no_int'];
			$tipoasentamiento=$result_clientes_row_direccion['asentamiento'];
			$asentamiento=$result_clientes_row_direccion['col'];
			$codigo=$result_clientes_row_direccion['cp'];
       ...
       ?>
		<tr>
		  <th colspan="5" scope="row">
			  NO EXISTE NINGUNA DIRECCION DE ENVIO REGISTRADA
		  </th>
	    </tr>
		<?php
		   }
