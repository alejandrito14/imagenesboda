...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">LISTADO DE COSTOS DE ENVÍO POR DÍA</h5>
		...
		<div style="float:right;">
			...
			<?php
				...
				$bt->funcion = "aparecermodulos('catalogos/costospordia/fa_costo.php?idmenumodulo=$idmenumodulo','main');";
				...
				<tbody>
					...
					if($l_costos_num== 0){
						...
						do
						{
							...
							<td style="text-align: center;"><?php echo date('d-m-Y',strtotime($l_costos_row['fecha']));?></td>
							<td style="text-align: center;"><?php echo $l_costos_row['horainicial'].' - '.$l_costos_row['horafinal'];?></td>
							...
							<td style="text-align: center; font-size: 15px;">
									...
									$bt->funcion = "aparecermodulos('catalogos/costospordia/fa_costo.php?idmenumodulo=$idmenumodulo&idcostoenvio=".$l_costos_row['idfechaenvio']."','main')";
									$bt->estilos = "";
									$bt->permiso = $permisos;
									$bt->tipo = 2;
									$bt->title="EDITAR";
									...
									$bt->funcion = "BorrarCostoEnviodia('".$l_costos_row['idfechaenvio']."','".$idmenumodulo."')";
									$bt->estilos = "";
									$bt->permiso = $permisos;
									$bt->tipo = 3;
									$bt->title="BORRAR";
