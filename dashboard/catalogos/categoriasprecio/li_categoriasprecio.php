...
$emp->idcategoriaprecios = $idcategoria;
$emp->nombre = $nombre;
$emp->empresa = $empresa;
	...
	<tbody>
			...
			<tr> 
				<td colspan="7" style="text-align: center">
					<h5 class="alert_warning">NO EXISTEN CATEGORIAS DE PRECIOS EN LA BASE DE DATOS.</h5>
				</td>
			</tr>
			<?php
			}else{
			...
			?>
			<tr>
			    <td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($resultado_empresas_row['idcategoria_precios']); ?></td>
				...
				<td style="text-align: center; font-size: 15px;">
				   <!--<i class="mdi mdi-table-edit" onclick="aparecermodulos('catalogos/empresas/fa_empresas.php?idempresas=<?php echo $resultado_empresas_row['idempresas'];?>','main')" style="cursor: pointer" title="Modificar Empresas"></i>-->
					...
					<?php
						...
						$bt->funcion = "aparecermodulos('catalogos/categoriasprecio/fa_categoriasprecio.php?idcategoriaprecio=".$resultado_empresas_row['idcategoria_precios']."&idmenumodulo=$idmenumodulo','main')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
					...
					<?php
						...
						$bt->funcion = "BorrarDatosCategorias('".$resultado_empresas_row['idcategoria_precios']."','idcategoriaprecio','categoria_precios','n','catalogos/categoriasprecio/vi_categoriaprecios.php','main','$idmenumodulo')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->tipo = 3;
						$bt->title="BORRAR";
