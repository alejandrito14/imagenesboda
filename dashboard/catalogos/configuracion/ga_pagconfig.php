...
try
{
	...
	$conf->texto1=$_POST['texto1'];
	
	$conf->bloquearediciondatoscliente=$_POST['bloquearediciondatoscliente'];

	$conf->mostraranunciosapp=$_POST['mostraranunciosapp'];
	$conf->activaromitir=$_POST['activaromitir'];
