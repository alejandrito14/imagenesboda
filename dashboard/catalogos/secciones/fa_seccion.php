...
$noticia=new Noticia();
$calendario=new CalendarioSeccion();
...
if(!isset($_GET['idseccion'])){
	...
	$ordenseccion=$result_seccion_row['ordenseccion'];
...
$arraynoticias=array();
	if ($tipo==2) {
		...
		$noticiaslista=$noticia->Obtenernoticias();

		for ($i=0; $i < count($noticiaslista); $i++) { 
				$ruta="";
				if ($noticiaslista[$i]->imagen!='') {
				$ruta='./catalogos/secciones/imagenesnoticias/'.$_SESSION['codservicio'].'/'.$noticiaslista[$i]->imagen;
				}
		
			$orden=$noticiaslista[$i]->orden;
			$estatus1=$noticiaslista[$i]->estatus;
			$imagen=$noticiaslista[$i]->imagen;
			$enlace=$noticiaslista[$i]->enlace;
			$titulo=$noticiaslista[$i]->titulo;
			$descripcion=$noticiaslista[$i]->descripcion;
			$fechapublicacion=$noticiaslista[$i]->fecha;


			$info = array('ruta' => $ruta,'ordennoticia'=>$orden,'v_estatusnoticia'=>$estatus1,'nombreimagen'=>$imagen,'enlace'=>$enlace,'titulonoticia'=>$titulo,'descripcion'=>$descripcion,'fechapublicacion'=>$fechapublicacion);
			array_push($arraynoticias,$info);
		}
	}

	$arrayfechas=array();
	if ($tipo==3) {
		$calendario->idseccion=$idseccion;
		$calendariofechas=$calendario->Obtenercalendario();

		for ($i=0; $i < count($calendariofechas); $i++) { 
				$ruta="";
				if ($calendariofechas[$i]->imagen!='') {
				$ruta='./catalogos/secciones/imagenesfecha/'.$_SESSION['codservicio'].'/'.$calendariofechas[$i]->imagen;
				}
		
			$orden=$calendariofechas[$i]->orden;
			$estatus1=$calendariofechas[$i]->estatus;
			$imagen=$calendariofechas[$i]->imagen;
			$descripcion=$calendariofechas[$i]->descripcion;
			$fecha=$calendariofechas[$i]->fecha;


			$info = array('ruta' => $ruta,'ordenfecha'=>$orden,'v_estatusfecha'=>$estatus1,'nombreimagen'=>$imagen,'descripcion'=>$descripcion,'fecha'=>$fecha);
			array_push($arrayfechas,$info);
		}
	}
...
<form id="f_seccion" name="f_seccion" method="post" action="">
	...
	<div class="row">
					...
					<div class="tab-content tabcontent-border">
						<div class="tab-pane active show" id="generales" role="tabpanel">
							...
							<div class="form-group">
								...
								<input type="number" class="form-control" id="v_orden" value="<?php echo $ordenseccion;?>" title="ORDEN">
							</div>
						...
						<div class="form-group m-t-20">
							<label>TIPO:</label>
							<select name="v_tipo" id="v_tipo" title="Tipo" class="form-control"  onchange="SeleccionarTipo()">
		...
		<div class="col-md-12 divrevista"  style="display:none;">
	<div class="card">
...
<div class="col-md-12 divnoticias" style="display:none;">
	<div class="card">
		<div class="card-header">

			<div class="row">
					
				<div class="col-md-4"><label style="font-size: 16px;">NOTICIAS</label></div>
						<div class="col-md-4">
								
						</div>
						<div class="col-md-4">
								<button type="button" onclick="AbrirModalNoticias()" class="btn btn-primary">AGREGAR</button>
						</div>
						</div>
		...
		<div class="card-body col-md-12">
			...
			<div class="col-md-12 divcalendario" style="display:none;">
	<div class="card">
		<div class="card-header">

			<div class="row">
					
				<div class="col-md-4"><label style="font-size: 16px;">CALENDARIO</label></div>
						<div class="col-md-4">
								
						</div>
						<div class="col-md-4">
								<button type="button" onclick="AbrirModalFechas()" class="btn btn-primary">AGREGAR</button>
						</div>
						</div>
...
<div class="modal" id="modalnoticias" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="row">
       	<div class="" style="justify-content: center;text-align: center;margin: auto;">
			...
			<div class="card" style="width: 18rem;margin: auto;margin-top: 3em;">
			 <img class="card-img-top imagennoticia" src="">
					<div id="d_fotonoticia" style="text-align:center; ">
						<img src="images/sinfoto.png" class="card-img-top" alt="" style="border: 1px #777 solid"> 
					</div>
					<div class="card-body">
						 <h5 class="card-title"></h5>
						 ...
						 <input type="file" class="form-control-file" name="imagenoticia" id="imagenoticia" onchange="SubirImagendenoticia()">
		 				</div>
								         
					  </div>
	  				  </div>
								
					<p style="text-align: center;">Dimensiones de la imagen Ancho:640px Alto:350px</p>
				...
				<div class="">
							...
							<div class="">
								...
								<textarea class="form-control" name="txtdescripcionnoticia" id="txtdescripcion" cols="20" rows="5"></textarea>
							</div>
							</div>
							...
							<div class="">
								...
								<textarea class="form-control" name="txtenlace" id="txtenlace" cols="20" rows="5"></textarea>
							</div>
							</div>
							...
							<div class="">
								...
								<input type="date" style="display: none;" id="fechapublicacion" value="<?php echo date('Y-m-d') ?>" >
							</div>
							</div>
							...
							<div class="">
								<div class="form-group">
								<label for="">ORDEN:</label>
								<input type="number" id="ordennoticia" class="form-control">
							</div>
							</div>
							...
							<div class="">
								<div class="form-group ">
							<label>ESTATUS:</label>
							<select name="v_estatusnoticia" id="v_estatusnoticia" title="Estatus" class="form-control"  >
								<option value="0" <?php if($estatus == 0) { echo "selected"; } ?> >DESACTIVO</option>
								<option value="1" <?php if($estatus == 1) { echo "selected"; } ?> >ACTIVADO</option>
							</select>
						</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btnnoticiaguardar" onclick="GuardarDatosNoticia(-1)">Guardar</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
      </div>
    </div>
  </div>
      ...
      <div class="modal-body">
       ...
       <div class="row">
       	<div class="" style="justify-content: center;text-align: center;margin: auto;">
			...
			<div class="card" style="width: 18rem;margin: auto;margin-top: 3em;">
			 <img class="card-img-top imagenfecha" src="">
					<div id="d_fotofecha" style="text-align:center; ">
						<img src="images/sinfoto.png" class="card-img-top" alt="" style="border: 1px #777 solid"> 
					</div>
					<div class="card-body">
						 <h5 class="card-title"></h5>
						 ...
						 <input type="file" class="form-control-file" name="imagefecha" id="imagefecha" onchange="SubirImagendefecha()">
		 				</div>
				...
				<div class="col-md-6">
							...
							<div class="">
								...
								<input type="date"  id="fechacalendario" class="form-control" value="<?php echo date('Y-m-d') ?>" >
							</div>
							</div>
								...
								<div class="form-group">
								<label for="">DESCRIPCIÓN:</label>
								<textarea class="form-control" name="txtdescripcionfecha" id="txtdescripcionfecha" cols="20" rows="5"></textarea>
							</div>
							</div>
							...
							<!-- <div class="">
								<div class="form-group">
								<label for="">ORDEN:</label>
								<input type="number" id="ordenfecha" class="form-control">
							</div>
							</div>
 -->
							<div class="">
								<div class="form-group ">
							<label>ESTATUS:</label>
							<select name="v_estatusfecha" id="v_estatusfecha" title="Estatus" class="form-control"  >
								<option value="0" <?php if($estatus == 0) { echo "selected"; } ?> >DESACTIVO</option>
								<option value="1" <?php if($estatus == 1) { echo "selected"; } ?> >ACTIVADO</option>
							</select>
						</div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary" id="btnfechaguardar" onclick="GuardarDatosfecha(-1)">Guardar</button>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
      </div>
    </div>
  </div>
...
<script>
	...
	var imagenprincipal="";
	var imagenespromo=[];
	var imagenesdenoticia=[];
	var imagenescalendario=[];
	...
	if (idseccion>0) {
		...
		if (tipo==2) {
			 	...
			 	var imagenesdenoticia=<?php echo json_encode($arraynoticias) ?>;
			 ...
			 if (tipo==3) {
			 	...
			 	var imagenescalendario=<?php echo json_encode($arrayfechas) ?>;
    ...
    function SubirImagendepromo() {
     ...
     function SubirImagendenoticia() {

    	 var formData = new FormData();
        var files = $('#imagenoticia')[0].files[0];
        formData.append('file',files);
        $.ajax({
            url: 'catalogos/secciones/uploadimagennoticia.php',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
	      ...
	      $("#d_fotonoticia").html('<div align="center" class="mostrar"><img src="images/loader.gif" alt="" /><br />Cargando...</div>');	

		    },
        	success: function(response) {
               	var ruta3='<?php echo $ruta; ?>';
	
                if (response != 0) {
                    $(".imagennoticia").attr("src", response);
                    $("#d_fotonoticia").css('display','none');
                } else {

                	 $("#d_fotonoticia").html('<img src="'+ruta+'" class="card-img-top" alt="" style="border: 1px #777 solid"/> ');
                    alert('Formato de imagen incorrecto.');
                }
            }
        });
      ...
      function SubirImagendefecha() {

    	 var formData = new FormData();
        var files = $('#imagefecha')[0].files[0];
        formData.append('file',files);
        $.ajax({

            url: 'catalogos/secciones/uploadimagenfecha.php',
            type: 'post',
            data: formData,
            contentType: false,
            processData: false,
	      ...
	      $("#d_fotofecha").html('<div align="center" class="mostrar"><img src="images/loader.gif" alt="" /><br />Cargando...</div>');	
        	...
        	success: function(response) {
                ...
                if (response != 0) {
                    $(".imagenfecha").attr("src", response);
                    $("#d_fotofecha").css('display','none');
                } else {

                	 $("#d_fotofecha").html('<img src="'+ruta+'" class="card-img-top" alt="" style="border: 1px #777 solid"/> ');
                    alert('Formato de imagen incorrecto.');
                }
            }
        });
