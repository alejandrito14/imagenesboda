				...
				<form id="f_Reportes" name="f_Reportes">
						...
						<div class="row">
								...
								<div class="form-group col-md-4" style="display: block;" >
									<label for="v_nombre">NOMBRE CLIENTE</label>
									<input name="v_nombre" id="v_nombre" class="form-control" type="text">
								</div>
								
								<div class="form-group col-md-4" style="display: block;" >
									<label for="v_paterno">APELLIDO PATERNO</label>
									<input name="v_paterno" id="v_paterno" class="form-control" type="text">
								</div>
								
								<div class="form-group col-md-4" style="display: block;" >
									<label for="v_materno">APELLIDO MATERNO</label>
									<input name="v_materno" id="v_materno" class="form-control" type="text">
								</div>
