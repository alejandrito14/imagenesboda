...
<div class="row">
	...
	<a class="btn btn-primary" title="Reporte" onClick="rpt_excel_emp_suc(<?php echo $idempresa; ?>);" style="margin-top: 5px; color: #ffffff"><i class="mdi mdi-account-search"></i>  REPORTE EXCEL</a>	
		</div>	
    					...
    					do
    					{
    						...
    						<tr>
    							...
    							<td style="text-align: center; font-size: 15px;">
									...
									<i class="btn btn-primary mdi mdi-file-excel" style="cursor: pointer" onclick="rpt_excel_emp_y_suc('<?php echo $sql_empresas_row['idempresas'];?>','<?php echo $result_sucursales_row['idsucursales'];?>')" ></i>
<!--
