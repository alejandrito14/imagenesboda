...
$idcategoria = $_GET['v_idcategoria'];
...
WHERE productos.idempresas = '".$idempresas."' AND productos.idcategorias = '".$idcategoria."'
...
<?php	}else{?>
	...
	<option value="0">SELECCIONAR TIPO PRESENTACI&Oacute;N</option>

	<?php do
	{?>
		<option value="<?php echo $result_row['idtipo_presentacion']?>"><?php echo $f->imprimir_cadena_utf8($result_row['nombre']);?></option>
		<?php
