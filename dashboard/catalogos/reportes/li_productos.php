    ...
    $resultado_num = $db->num_rows($result_unidadmedida);
			...
			<?php	}else{?>
					...
					<option value="0">SELECCIONAR PRODUCTO</option>
						...
						do{
							?>
										<option value="<?php echo $resultado_row['idproducto']?>">

											<?php 

											 echo $resultado_row['idproducto'] ." - " .$rpt->mayus($f->imprimir_cadena_utf8($resultado_row['nombre']));?></option>
									<?php
