		...
		<div class="card-body">
			<div class="col-md-12" style="background-color: #C9C9C9; border-radius: 4px; padding: 5px;">
				...
				<form id="f_Reportes" name="f_Reportes">
							...
							<div class="row">
								...
								<div class="form-group col-md-4"style="display: block;" id="list_empresas">
									<label for="exampleInputEmail1">EMPRESA</label>
										<select name="v_idempresa" id="v_idempresa" class="form-control" onChange="Carga_li_productos()">
							...
							<div class="form-group col-md-4" style="display: block;" id="list_categorias">
									<label for="exampleInputEmail1">FAMILIA</label>
									<select name="v_idcategorias" id="v_idcategorias" class="form-control" onChange="CargarPresentacion()">
										  <option value="0">TODAS LAS FAMILIAS</option>								
									</select>
								</div>	

								<div class="form-group col-md-4" style="display: block;" id="list_presentacion">
									<label for="exampleInputEmail1">TIPO PRESENTACI&Oacute;N</label>
									<select name="v_idpresentacion" id="v_idpresentacion" class="form-control">
										  <option value="0">TODAS LAS PRESENTACIONES</option>								
									</select>
								</div>	

							<div class="form-group col-md-4	"style="display: block;" id="list_status">
									<label for="v_idpresentacion">ESTATUS</label>
										<select name="v_idstatus" id="v_idtipo" class="form-control">
											<option value="9" selected>TODOS LOS ESTATUS</option>	
