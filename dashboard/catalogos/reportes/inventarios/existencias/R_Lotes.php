...
$fechaInicio = date("Y-m-d",strtotime($fechaactual."- 1 month"));
...
<!--
								<div class="form-group col-md-3" style="display: block;" >
									<label for="v_fecha_final">FECHA CORTE</label>
								  <input name="v_fecha_corte" id="v_fecha_corte" class="form-control" type="date">
								</div>
-->					
