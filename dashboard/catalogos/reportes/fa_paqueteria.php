...
<form id="alta_paqueteria" method="post" action="">
	<div class="card mb-3">
		<div class="card-header">
			...
			<button type="button" onClick="aparecermodulos('catalogos/paqueterias/vi_paqueteria.php?idmenumodulo=<?php echo $idmenumodulo?>','main');" class="btn btn-info" style="float: right;">VER PAQUETER&Iacute;AS</button>
	...
	<div class="card mb-3">
		...
		<div class="card-footer text-muted">
			<input type="hidden" id="idpaqueterias" name="idpaqueterias" value="<?php echo $idpaqueterias ?>" />
				...
				$bt->titulo = "GUARDAR PAQUETERIA";
				$bt->icon = "mdi-plus-circle";
				$bt->funcion = "GuardarEspecial('alta_paqueteria','catalogos/paqueterias/ga_paqueteria.php','catalogos/paqueterias/vi_paqueteria.php?idmenumodulo=$idmenumodulo','main');";
