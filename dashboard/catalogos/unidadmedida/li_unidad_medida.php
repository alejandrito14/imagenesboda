...
<table class="table table-striped table-bordered" id="tbl_medidas" cellpadding="0" cellspacing="0" style="overflow: auto">
	<thead>
	...
	<tbody>
			...
			<tr> 
				<td colspan="7" style="text-align: center">
					<h5 class="alert_warning">NO EXISTEN MEDIDAS EN LA BASE DE DATOS.</h5>
				</td>
			</tr>
			<?php
			}else{
			...
			?>
			<tr>
			    <td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($resultado_empresas_row['idtipo_medida']); ?></td>
				<td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($resultado_empresas_row['nombre']); ?></td>
				<td style="text-align: center;"><?php echo $f->imprimir_cadena_utf8($resultado_empresas_row['medidaminima']);?></td>
				...
				<td style="text-align: center; font-size: 15px;">
				   <!--<i class="mdi mdi-table-edit" onclick="aparecermodulos('catalogos/empresas/fa_empresas.php?idempresas=<?php echo $resultado_empresas_row['idempresas'];?>','main')" style="cursor: pointer" title="Modificar Empresas"></i>-->
					...
					<?php
						...
						$bt->funcion = "aparecermodulos('catalogos/unidadmedida/fa_unidad_medida.php?idmedida=".$resultado_empresas_row['idtipo_medida']."&idmenumodulo=$idmenumodulo','main')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->title="EDITAR";
					...
					<?php
						...
						$bt->funcion = "BorrarDatos('".$resultado_empresas_row['idtipo_medida']."','idtipo_medida','tipo_medida','n','catalogos/unidadmedida/vi_unidad_medida.php','main','$idmenumodulo')";
						$bt->estilos = "";
						$bt->permiso = $permisos;
						$bt->tipo = 3;
						$bt->title="BORRAR";
...
<script type="text/javascript">
	 $('#tbl_medidas').DataTable( {		
		 	"pageLength": 100,
			"oLanguage": {
						"sLengthMenu": "Mostrar _MENU_ ",
						"sZeroRecords": "NO EXISTEN MEDIDAS EN LA BASE DE DATOS.",
