...
<div class="card">
	<div class="card-body">
		<h5 class="card-title" style="float: left;">LISTADO DE UNIDADES DE MEDIDA</h5>
		...
		<div style="float:right;">
			...
			<?php
				...
				$bt->titulo = "NUEVA UNIDAD DE MEDIDA";
				$bt->icon = "mdi-plus-circle";
				$bt->funcion = "aparecermodulos('catalogos/unidadmedida/fa_unidad_medida.php?idmenumodulo=$idmenumodulo','main');";
				$bt->estilos = "float: right; margin-right:10px;";
				$bt->permiso = $permisos;
				$bt->tipo = 5;
				$bt->title="NUEVA UNIDAD DE MEDIDA";
				$bt->armar_boton();
				...
				<tbody>
					<tr> 
						<td colspan="7" style="text-align: center">
	  						<h4 class="alert_warning">NO EXISTEN MEDIDAS EN LA BASE DE DATOS.</h4>
		  				</td>
	  				</tr>
				</tbody>
			</table>
				...
				<div class="widget-box">
					<div class="widget-content">
						...
						<div class="form-group">
							...
							<select name="b_estatus" id="b_estatus" class="form-control">
						...
						<div class="span3" style="margin: 0; float: right;">
							<br>
							<button class="btn btn-primary" onClick="Buscar_UnidadMedida(<?php echo $idmenumodulo; ?>);" style="margin-top: 5px;"><i class="mdi mdi-account-search"></i>  BUSCAR</button>
						</div>
...
<script type="text/javascript">
	Buscar_UnidadMedida(<?php echo ($idmenumodulo);?>);
</script>