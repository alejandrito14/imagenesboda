...
<div class="card mb-3">
	<div class="card-header">
		<h5 class="card-title" style="float: left; margin-top: 5px;">RANKIN DE JUGADORES</h5>
			...
			<table id="zero_config" class="table table-bordered table-hover" cellpadding="0" cellspacing="0">
				<thead>
					...
					<!--	<th>NIVEL</th> -->
						...
						<th  style="text-align: center;">JUEGOS GANADOS</th>
						<th  style="text-align: center;">JUEGOS PERDIDOS</th>
						<th  style="text-align: center;">PUNTOS GANADOS</th>
				...
				<tbody>
					...
					?>
						...
						<tr> 
							...
							<td style="text-align: center;" width="30"><?php echo utf8_encode($result_row['idcliente']); ?></td>
						  	...
						  	<td style="text-align: center;"><?php 
						  		...
						  		$cli->idCliente=$result_row['idcliente'];
						  		$jugados=$cli->ObtenerJugados();
						  	...
						  	<td style="text-align: center;">
						  		...
						  		$contar=$cli->ObtenerJugadosGanados();
						  		echo $contar;
						  	...
						  	<td style="text-align: center;">
						  		...
						  		$perdidos=$cli->ObtenerJugadosPerdidos();
						  		echo $perdidos;
