...
$idmenumodulo = $_GET['idmenumodulo'] ?? null;
...
$permisos = '';
if ($idmenumodulo !== null) {
	// Nombre de sesión | pag-idmodulos_menu
...
<div class="row">
                            ...
                            <div class="col-xl-3 col-md-6" style="display: none;">
                             ...
                             <div class="col-xl-3 col-md-6" id="versionactualdiv" style="display: none;">
                                <div class="card bg-success text-white mb-4">
