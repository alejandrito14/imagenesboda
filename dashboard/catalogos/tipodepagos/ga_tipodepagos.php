...
try
{
	...
	$tipodepagos->porcentajecomision=$_POST['porcentajecomision'];
	$tipodepagos->montotransaccion=$_POST['montotransaccion'];
	$tipodepagos->porcentajeimpuesto=$_POST['porcentajeimpuesto'];
	...
	$tipodepagos->habilitarmercadopago=$_POST['conmercadopago'];	
	$tipodepagos->claveprivadamercado=$_POST['claveprivadamercado'];
	$tipodepagos->clavepublicamercaoo=$_POST['clavepublicamercado'];
