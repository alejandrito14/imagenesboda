...
if(!isset($_GET['idtipodepago'])){
	...
	$conmercadopago=$result_tipodepagos_row['habilitarmercadopago'];
	$claveprivadamercado=$result_tipodepagos_row['keyprivadamercado'];
	$clavepublicamercado=$result_tipodepagos_row['keypublicamercado'];
					...
					<div class="tab-content tabcontent-border">
						<div class="tab-pane active show" id="generales" role="tabpanel">
							...
							<div class="form-group">
								...
								<input type="checkbox" class="" id="conmercadopago" name="conmercadopago" onchange="habilitarmercadopago()" value="<?php echo $conmercadopago; ?>" title="HABILITAR MERCADO PAGO" placeholder='HABILITAR MERCADO PAGO' <?php echo $chemercado?>>
							</div>
							

								<div class="form-group privadamercado" style="display: <?php echo $visualizarmercado;?>;">
								<label>CLAVE PRIVADA:</label>
								<input type="text" class="form-control" id="claveprivadamercado" name="claveprivadamercado" value="<?php echo $claveprivadamercado; ?>" title="CLAVE PRIVADA" placeholder='CLAVE PRIVADA'>
							</div>

							<div class="form-group publicamercado" style="display: <?php echo $visualizarmercado;?>;">
								<label>CLAVE PUBLICA:</label>
								<input type="text" class="form-control" id="clavepublicamercado" name="clavepublicamercado" value="<?php echo $clavepublicamercado; ?>" title="CLAVE PUBLICA" placeholder='CLAVE PUBLICA'>
							</div>
...
<script type="text/javascript">
	var habilitarcampo='<?php echo $habilitarcampo; ?>';
	...
	$("#habilitarcampomonto").val(habilitarcampo);
